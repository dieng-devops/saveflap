# -*- encoding: utf-8 -*-
# stub: trailblazer-rails 1.0.9 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<trailblazer>.freeze, ["~> 2.0.0"])
      s.add_runtime_dependency(%q<trailblazer-loader>.freeze, [">= 0.1.0"])
      s.add_runtime_dependency(%q<reform-rails>.freeze, [">= 0.1.4", "< 0.2.0"])
      ...
      s.add_dependency(%q<trailblazer>.freeze, ["~> 2.0.0"])
      s.add_dependency(%q<trailblazer-loader>.freeze, [">= 0.1.0"])
      s.add_dependency(%q<reform-rails>.freeze, [">= 0.1.4", "< 0.2.0"])
