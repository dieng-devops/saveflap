# -*- encoding: utf-8 -*-
# stub: trailblazer-operation 0.7.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<trailblazer-activity-dsl-linear>.freeze, [">= 0.4.0", "< 1.0.0"])
      ...
      s.add_dependency(%q<trailblazer-activity-dsl-linear>.freeze, [">= 0.4.0", "< 1.0.0"])
