# -*- encoding: utf-8 -*-
# stub: trailblazer-macro 2.1.0.beta4 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<trailblazer-operation>.freeze, ["< 0.3.0", ">= 0.2.5"])
      s.add_development_dependency(%q<trailblazer-macro-contract>.freeze, ["< 2.2.0", ">= 2.1.0.beta1"])
      s.add_development_dependency(%q<reform>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<trailblazer-operation>.freeze, ["< 0.3.0", ">= 0.2.5"])
      s.add_dependency(%q<trailblazer-macro-contract>.freeze, ["< 2.2.0", ">= 2.1.0.beta1"])
      s.add_dependency(%q<reform>.freeze, [">= 0"])
