# -*- encoding: utf-8 -*-
# stub: trailblazer-macro-contract 2.1.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2021-03-03"
  s.description = "Operation macros for form objects".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<reform-rails>.freeze, ["~> 0.2.0.rc2"])
      s.add_development_dependency(%q<trailblazer-operation>.freeze, [">= 0.6.2"])
      s.add_development_dependency(%q<trailblazer-macro>.freeze, [">= 2.1.5"])
      s.add_development_dependency(%q<trailblazer-developer>.freeze, [">= 0"])
      s.add_development_dependency(%q<activemodel>.freeze, ["~> 6.0.0"])
      ...
      s.add_dependency(%q<reform-rails>.freeze, ["~> 0.2.0.rc2"])
      s.add_dependency(%q<trailblazer-operation>.freeze, [">= 0.6.2"])
      s.add_dependency(%q<trailblazer-macro>.freeze, [">= 2.1.5"])
