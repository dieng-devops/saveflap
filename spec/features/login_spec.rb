...
feature 'Login', js: true do
  scenario 'When existing user try to login' do
    FactoryBot.create(:user, email: "toto@example.net", password: 'blabla', password_confirmation: 'blabla')
    load_server_host
  ...
  scenario 'When disabled user try to login' do
    FactoryBot.create(:user, email: "toto@example.net", password: 'blabla', password_confirmation: 'blabla', enabled: false)
    load_server_host
    visit main_app.root_path
    fill_in :user_email, with: 'toto@example.net'
    fill_in :user_password, with: 'blabla'
